...
namespace OVATerrariaMod.Items.Weapons
{
	public class Kusanagi : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("How does this thing even stay together?");  //The (English) text shown below your weapon's name
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType<KusanagiWind>(); //IMPORTANT: THIS SETS THE PROJECTILE TO BE FIRED BY THE WEAPON. if you want a projectile sword, set this to the ID of whatever projectile you want.
			item.shootSpeed = 11f;
		}
