...
{
	public class SexPistolBullet : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sex Pistol Bullet");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			projectile.CloneDefaults(207); aiType = 207;
		}
